...
@class GrowthBookGBLocalContext, GrowthBookGBExperiment, GrowthBookGBExperimentResult, GrowthBookGBFeatureResult, GrowthBookKotlinx_serialization_jsonJsonElement, GrowthBookGBExperimentCompanion, GrowthBookGBFeatureRule, GrowthBookGBFeatureCompanion, GrowthBookGBFeatureSource, GrowthBookGBFeatureRuleCompanion, GrowthBookKotlinEnumCompanion, GrowthBookKotlinEnum<E>, GrowthBookKotlinArray<T>, GrowthBookKotlinx_serialization_jsonJsonElementCompanion, GrowthBookKotlinx_serialization_coreSerializersModule, GrowthBookKotlinx_serialization_coreSerialKind, GrowthBookKotlinNothing;

@protocol GrowthBookKotlinx_serialization_coreKSerializer, GrowthBookKotlinComparable, GrowthBookKotlinx_serialization_coreEncoder, GrowthBookKotlinx_serialization_coreSerialDescriptor, GrowthBookKotlinx_serialization_coreSerializationStrategy, GrowthBookKotlinx_serialization_coreDecoder, GrowthBookKotlinx_serialization_coreDeserializationStrategy, GrowthBookKotlinIterator, GrowthBookKotlinx_serialization_coreCompositeEncoder, GrowthBookKotlinAnnotation, GrowthBookKotlinx_serialization_coreCompositeDecoder, GrowthBookKotlinx_serialization_coreSerializersModuleCollector, GrowthBookKotlinKClass, GrowthBookKotlinKDeclarationContainer, GrowthBookKotlinKAnnotatedElement, GrowthBookKotlinKClassifier;
...
__attribute__((swift_name("GrowthBookLocalSDK")))
@interface GrowthBookGrowthBookLocalSDK : GrowthBookBase
- (instancetype)initWithLocalContext:(GrowthBookGBLocalContext *)localContext growthBookFeatures:(NSString *)growthBookFeatures trackingCallback:(void (^)(GrowthBookGBExperiment *, GrowthBookGBExperimentResult *))trackingCallback __attribute__((swift_name("init(localContext:growthBookFeatures:trackingCallback:)"))) __attribute__((objc_designated_initializer));
- (GrowthBookGBFeatureResult * _Nullable)featureFeatureKey:(NSString *)featureKey __attribute__((swift_name("feature(featureKey:)")));
@end;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GBLocalContext")))
@interface GrowthBookGBLocalContext : GrowthBookBase
- (instancetype)initWithEnabled:(BOOL)enabled attributes:(NSDictionary<NSString *, id> *)attributes forcedVariations:(NSDictionary<NSString *, GrowthBookInt *> *)forcedVariations qaMode:(BOOL)qaMode __attribute__((swift_name("init(enabled:attributes:forcedVariations:qaMode:)"))) __attribute__((objc_designated_initializer));
...
@interface GrowthBookJsonUtilsKt : GrowthBookBase
+ (id)convertToPrimitiveIfPossibleJsonElement:(id)jsonElement __attribute__((swift_name("convertToPrimitiveIfPossible(jsonElement:)")));
@end;
